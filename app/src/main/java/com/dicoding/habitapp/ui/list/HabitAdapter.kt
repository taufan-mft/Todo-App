...
class HabitAdapter(
    ...
    inner class HabitViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(habit: Habit) {
            ...
            when (habit.priorityLevel.toUpperCase()) {
                "HIGH"-> ivPriority.setImageDrawable(ContextCompat.getDrawable(ivPriority.context, R.drawable.ic_priority_high))

                "MEDIUM" -> ivPriority.setImageDrawable(ContextCompat.getDrawable(ivPriority.context, R.drawable.ic_priority_medium))

                "LOW" -> ivPriority.setImageDrawable(ContextCompat.getDrawable(ivPriority.context, R.drawable.ic_priority_low))
